...
class DataSaver:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.gesture_name = config['paths']['gesture_folder'].name
        self.image_format = config['processing']['image_format']
